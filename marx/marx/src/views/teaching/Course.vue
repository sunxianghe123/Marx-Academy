    ...
    <div class="content">
      <con-nav>
        <div slot="first" class="active">
          <router-link to="/course">课程设置</router-link>
        </div>
        <div slot="second">
          <router-link to="/institution">文件制度</router-link>
        </div>
      </con-nav>
      <div class="summarize">
        <summarize-title>
          <div slot="left">【课程设置】</div>
          <div slot="right" v-html="title"></div>
        </summarize-title>
        <summarize-item>
          <div slot="item-left">课程设置</div>
