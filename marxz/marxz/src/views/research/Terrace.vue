<template>
  <div class="subject">
    ...
    <div class="content">
      <con-nav>
        <div slot="first">
          <router-link to="/subject">学科建设</router-link>
        </div>
        <div slot="second" class="active">
          <router-link to="/terrace">教研平台</router-link>
        </div>
        <div slot="third">
          <router-link to="/institutions">文件制度</router-link>
        </div>
      </con-nav>
      <div class="summarize">
        <summarize-title>
          <div slot="left">【教研平台】</div>
          <div slot="right" v-html="title"></div>
        </summarize-title>
        <summarize-item>
          <div slot="item-left">教研平台</div>
