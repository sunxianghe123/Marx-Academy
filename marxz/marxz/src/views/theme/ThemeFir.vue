    ...
    <div class="content">
      <con-nav>
        <div slot="first" class="active">
          <router-link to="/themefir" style="line-height: 1; padding: 15px 0;">
            “不忘初心，牢记使命”主题教育
          </router-link>
        </div>
        <div slot="second">
      ...
      <div class="summarize">
        <summarize-title>
          <div slot="left">【“不忘初心，牢记使命”主题教育】</div>
          <div slot="right" v-html="title"></div>
        </summarize-title>
        <summarize-item>
          <div slot="item-left">“不忘初心，牢记使命”主题教育</div>
...
export default {
  ...
  data() {
    return {
      title: '您当前的位置是：专题专栏>“不忘初心，牢记使命”主题教育',
    }
  },
  methods: {
  }
